{
 "cells": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": null,
   "id": "1aa45c73-d16d-44b2-8d42-751027f8811c",
   "metadata": {},
   "outputs": [],
   "source": []
  },
  ...
  },
  {
   "cell_type": "code",
   "execution_count": null,
   "id": "eb7058e2-90a4-4533-8b84-ba7c69197c68",
   "metadata": {},
   "outputs": [],
   "source": []
  },
  {
   "cell_type": "code",
   "execution_count": null,
   "id": "efd23508-d256-47ec-9a92-c27c060ffd90",
   "metadata": {},
   "outputs": [],
   "source": []
  },
  ...
  },
  {
   ...
   "source": [
    ...
    "\n",
    "# Create a boxplot for concentration data for each hour, separated by weekday and weekend\n",
    "sns.boxplot(x='Month', y='PM 2.5', data= key_df, color= 'gold', showfliers=False, whis= [10, 90])\n",
    "\n",
    "\n",
    "# Add horizontal lines connecting the medians\n",
    "medians_weekday = key_df.groupby('Month')['PM 2.5'].median().values\n",
    "medians_weekend = key_df.groupby('Month')['PM 2.5'].median().values\n",
    "plt.plot(range(len(medians_weekday)), medians_weekday, color='yellow', linestyle='-', linewidth=2, label='Hourly Median')\n",
    "\n",
    "plt.title('Malden PM 2.5(ug/m\\u00b3)')\n",
    "plt.xlabel('Month of Year')\n",
    "plt.ylabel('Concentration (ug/m\\u00b3)')\n",
    "plt.legend()\n",
    "\n",
    "plt.ylim(0, 50)  # Adjust the multiplier as needed to provide some space above the highest value\n",
    "\n",
    "# Add horizontal gridlines only\n",
    "plt.grid(axis='y')\n",
    "\n",
    ...
    "\n",
    "# Save plot as JPEG file\n",
    "plt.savefig(r\"C:\\Users\\cgimil01\\Box\\Master'sThesis\\Temp\\Monthly Trends\\ML_PM25.png\", dpi=500)\n",
    "plt.show()\n",
    "\n",
    "plt.figure(figsize=(12, 6))\n",
    "\n",
    "# Create a boxplot for concentration data for each hour, separated by weekday and weekend\n",
    "sns.boxplot(x='Month', y='PM 10', data= key_df, color= 'maroon', showfliers=False, whis= [10, 90])\n",
    "\n",
    "\n",
    "# Add horizontal lines connecting the medians\n",
    "medians_weekday = key_df.groupby('Month')['PM 10'].median().values\n",
    "medians_weekend = key_df.groupby('Month')['PM 10'].median().values\n",
    "plt.plot(range(len(medians_weekday)), medians_weekday, color='coral', linestyle='-', linewidth=2, label='Hourly Median')\n",
    "\n",
    "plt.title('Malden PM 10 (ug/m\\u00b3)')\n",
    "plt.xlabel('Month of Year')\n",
    "plt.ylabel('Concentration (ug/m\\u00b3)')\n",
    "plt.legend()\n",
    "\n",
    "plt.ylim(0, 100)  # Adjust the multiplier as needed to provide some space above the highest value\n",
    "\n",
    "# Add horizontal gridlines only\n",
    "plt.grid(axis='y')\n",
    "\n",
    ...
    "\n",
    "# Save plot as JPEG file\n",
    "plt.savefig(r\"C:\\Users\\cgimil01\\Box\\Master'sThesis\\Temp\\Monthly Trends\\ML_PM10.png\", dpi=500)\n",
    "plt.show()"
   ]
  },
  {
   ...
   "source": [
    ...
    "\n",
    "# Create a boxplot for concentration data for each hour, separated by weekday and weekend\n",
    "sns.boxplot(x='Month', y='Large (#/cm^3)', data= key_df, color= 'yellowgreen', showfliers=False, whis= [10, 90])\n",
    "\n",
    "\n",
    "# Add horizontal lines connecting the medians\n",
    "medians_weekday = key_df.groupby('Month')['Large (#/cm^3)'].median().values\n",
    "medians_weekend = key_df.groupby('Month')['Large (#/cm^3)'].median().values\n",
    "plt.plot(range(len(medians_weekday)), medians_weekday, color='greenyellow', linestyle='-', linewidth=2, label='Hourly Median')\n",
    "\n",
    "plt.title('Malden Large Particles (#/cm\\u00b3)')\n",
    "plt.xlabel('Month of Year')\n",
    "plt.ylabel('Concentration (#/cm\\u00b3)')\n",
    "plt.legend()\n",
    "\n",
    "plt.ylim(0, 1)  # Adjust the multiplier as needed to provide some space above the highest value\n",
    "\n",
    "# Add horizontal gridlines only\n",
    "plt.grid(axis='y')\n",
    "\n",
    ...
    "\n",
    "# Save plot as JPEG file\n",
    "plt.savefig(r\"C:\\Users\\cgimil01\\Box\\Master'sThesis\\Temp\\Monthly Trends\\ML_Large.png\", dpi=500)\n",
    "plt.show()\n",
    "\n",
    "plt.figure(figsize=(12, 6))\n",
    "\n",
    "# Create a boxplot for concentration data for each hour, separated by weekday and weekend\n",
    "sns.boxplot(x='Month', y='Small (#/cm^3)', data= key_df, color= 'mediumslateblue', showfliers=False, whis= [10, 90])\n",
    "\n",
    "\n",
    "# Add horizontal lines connecting the medians\n",
    "medians_weekday = key_df.groupby('Month')['Small (#/cm^3)'].median().values\n",
    "medians_weekend = key_df.groupby('Month')['Small (#/cm^3)'].median().values\n",
    "plt.plot(range(len(medians_weekday)), medians_weekday, color='fuchsia', linestyle='-', linewidth=2, label='Hourly Median')\n",
    "\n",
    "plt.title('Malden Small Particles (#/cm\\u00b3)')\n",
    "plt.xlabel('Month of Year')\n",
    "plt.ylabel('Concentration (#/cm\\u00b3)')\n",
    "plt.legend()\n",
    "\n",
    "plt.ylim(0, 30)  # Adjust the multiplier as needed to provide some space above the highest value\n",
    "\n",
    "# Add horizontal gridlines only\n",
    "plt.grid(axis='y')\n",
    "\n",
    ...
    "\n",
    "# Save plot as JPEG file\n",
    "plt.savefig(r\"C:\\Users\\cgimil01\\Box\\Master'sThesis\\Temp\\Monthly Trends\\ML_small.png\", dpi=500)\n",
    "plt.show()\n"
   ]
  },
  {
  ...
  },
  {
   "cell_type": "code",
   "execution_count": null,
   "id": "45588fbb-eaf6-467c-8859-1fa2436de314",
   "metadata": {},
   "outputs": [],
   "source": [
    ...
    "X = main_df[['UFP Concentration', 'PM 2.5', 'PM 10']]\n",
    "kmeans.fit(X)\n",
  ...
  },
  {
   "cell_type": "code",
   "execution_count": null,
   "id": "fbd52528-3080-4321-afa1-e7d47d36b489",
   "metadata": {},
   "outputs": [],
   "source": [
    ...
    "for k in range(2, 11):\n",
    "    print (k)\n",
    "    kmeans = KMeans(n_clusters=k,n_init=10, algorithm= \"elkan\")\n",
    "    kmeans.fit(X)\n",
    ...
    "    silhouette_index = silhouette_score(X, kmeans.labels_)\n",
  ...
  },
  {
   "cell_type": "code",
   "execution_count": null,
   "id": "4c9968e5-21e4-4a59-846e-4a04dd4789d4",
   "metadata": {},
   "outputs": [],
   "source": [
    "cluster1= pd.DataFrame(clust[1]) #Counting the number of hours in each cluster\n",
    "cluster1['DateTime'] = pd.to_datetime(cluster1['DateTime'], errors='coerce')\n",
    "cluster1['hour'] = cluster1['DateTime'].dt.hour\n",
    "cluster1['dayofweek']=cluster1['DateTime'].dt.dayofweek\n",
    "\n",
    "cluster0= pd.DataFrame(clust[0])\n",
    "cluster0['DateTime'] = pd.to_datetime(cluster0['DateTime'], errors='coerce')\n",
    "cluster0['hour'] = cluster0['DateTime'].dt.hour\n",
    "cluster0['dayofweek']=cluster0['DateTime'].dt.dayofweek\n",
    "\n",
    "cluster2= pd.DataFrame(clust[2])\n",
    "cluster2['DateTime'] = pd.to_datetime(cluster2['DateTime'], errors='coerce')\n",
    "cluster2['hour'] = cluster2['DateTime'].dt.hour\n",
    "cluster2['dayofweek']=cluster2['DateTime'].dt.dayofweek\n",
    "\n",
    "cluster3= pd.DataFrame(clust[3])\n",
    "cluster3['DateTime'] = pd.to_datetime(cluster3['DateTime'], errors='coerce')\n",
    "cluster3['hour'] = cluster3['DateTime'].dt.hour\n",
    "cluster3['dayofweek']=cluster3['DateTime'].dt.dayofweek\n",
    "\n",
    "cluster4= pd.DataFrame(clust[4])\n",
    "cluster4['DateTime'] = pd.to_datetime(cluster4['DateTime'], errors='coerce')\n",
    "cluster4['hour'] = cluster4['DateTime'].dt.hour\n",
    "cluster4['dayofweek']=cluster4['DateTime'].dt.dayofweek\n",
    "\n",
    "clust0_hour= cluster0.groupby(['dayofweek','hour']).agg({'hour':'count'}) #Counting the number of each hour of the day in each cluster. \n",
    "clust0_hour= clust0_hour.rename(columns = {'hour':'cluster 0'})\n",
    "\n",
    "clust1_hour= cluster1.groupby(['dayofweek','hour']).agg({'hour':'count'})\n",
    "clust1_hour= clust1_hour.rename(columns = {'hour':'cluster 1'})\n",
    "\n",
    "clust2_hour= cluster2.groupby(['dayofweek','hour']).agg({'hour':'count'})\n",
    "clust2_hour= clust2_hour.rename(columns = {'hour':'cluster 2'})\n",
    "\n",
    "clust3_hour= cluster3.groupby(['dayofweek','hour']).agg({'hour':'count'})\n",
    "clust3_hour= clust3_hour.rename(columns = {'hour':'cluster 3'})\n",
    "\n",
    "clust4_hour= cluster4.groupby(['dayofweek','hour']).agg({'hour':'count'})\n",
    "clust4_hour= clust4_hour.rename(columns = {'hour':'cluster 4'})\n",
    "\n",
    "clust0_hour.sort_values(by= ['dayofweek','hour'])\n",
    "#clust0_hour.to_csv(\"/Users/camillegimilaro/Library/CloudStorage/Box-Box/UEP 237/Final Project/Cleaned Data/cluster0.csv\")\n",
    "\n",
    "clust1_hour.sort_values(by= ['dayofweek','hour'])\n",
    "#clust1_hour.to_csv(\"/Users/camillegimilaro/Library/CloudStorage/Box-Box/UEP 237/Final Project/Cleaned Data/cluster1.csv\")\n",
    "\n",
    "clust2_hour.sort_values(by= ['dayofweek','hour'])\n",
    "#clust2_hour.to_csv(\"/Users/camillegimilaro/Library/CloudStorage/Box-Box/UEP 237/Final Project/Cleaned Data/cluster2.csv\")\n",
    "\n",
    "\n",
    "clust3_hour.sort_values(by= ['dayofweek','hour'])\n",
    "#clust3_hour.to_csv(\"/Users/camillegimilaro/Library/CloudStorage/Box-Box/UEP 237/Final Project/Cleaned Data/cluster3.csv\")\n",
    "\n",
    "\n",
    "clust4_hour.sort_values(by= ['dayofweek','hour'])\n",
    "#clust4_hour.to_csv(\"/Users/camillegimilaro/Library/CloudStorage/Box-Box/UEP 237/Final Project/Cleaned Data/cluster4.csv\")\n"
   ]
  },
  {
   "cell_type": "code",
   "execution_count": null,
   "id": "2b37fe45-85e3-4cdb-b21b-333e979d374c",
   "metadata": {},
   "outputs": [],
   "source": [
    "hourly_counts= pd.concat([clust0_hour,clust1_hour, clust2_hour, clust3_hour, clust4_hour])\n",
    "hourly_counts.head()\n",
    "\n",
    "import seaborn as sns #plotting histogram of hourly counts\n",
    "fig, axes = plt.subplots(k,1, figsize=(15, 15))\n",
    "\n",
    "sns.histplot(clust0_hour, x= 'hour', color= row_colors[0], ax=axes[4], binwidth= 1)\n",
    "sns.histplot(clust1_hour, x= 'hour', color= row_colors[1], ax=axes[1], binwidth= 1)\n",
    "sns.histplot(clust2_hour, x= 'hour', color= row_colors[2], ax=axes[2], binwidth= 1)\n",
    "sns.histplot(clust3_hour, x= 'hour', color= row_colors[3], ax=axes[3], binwidth= 1)\n",
    "sns.histplot(clust4_hour, x= 'hour', color= row_colors[4], ax=axes[0], binwidth= 1)\n",
    "\n",
    "plt.tight_layout()\n",
    "\n",
    "plt.savefig('/Users/camillegimilaro/Desktop/Temp/ML_analysis/violinplots.png')"
   ]
  },
  {
   "cell_type": "code",
   "execution_count": null,
   "id": "f6a30c91-d69c-4949-96ea-177b0c15c984",
   "metadata": {},
   "outputs": [],
   "source": [
    "import seaborn as sns\n",
    ...
    "clust_hour = clust0_hour.join([clust1_hour, clust2_hour, clust3_hour, clust4_hour]).reset_index()\n",
    "\n",
    "plt.figure(figsize=(12,6))\n",
    "sns.heatmap(clust_hour.pivot(index='dayofweek', columns='hour'), cmap=\"viridis\", linewidths=0.5)\n",
    "\n",
    "plt.xlabel('Hour of the Day')\n",
    "plt.ylabel('Day of the Week')\n",
    "plt.title('Heatmap of Hourly Counts by Day for Each Cluster')\n",
    "plt.yticks(ticks=range(7), labels=['Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat', 'Sun'])\n",
    "plt.savefig('/Users/camillegimilaro/Desktop/Temp/ML_analysis/heatmap.png')\n",
    "plt.show()\n"
   ]
  },
  {
  ...
  },
  {
   "cell_type": "code",
   "execution_count": null,
   "id": "42aa938f-37d1-4a99-a0dd-62250a7aac04",
   "metadata": {},
   "outputs": [],
   "source": []
  }
